  ...
  (
    ...
    return (
      <SliderPrimitive.Root
        ...
        className={cn('relative flex w-full touch-none select-none mb-6 items-center cursor-pointer', className)}
        {...props}>
        ...
        {localValues.map((value, index) => (
          <React.Fragment key={index}>
            <div
              ...
              <span className="text-smtest">{formatLabel ? formatLabel(value) : value}</span>
            </div>
